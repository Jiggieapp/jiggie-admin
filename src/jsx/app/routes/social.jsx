...
var SocialBanner = React.createClass({
  ...
  //  var details = 'members/detail/' + uID ;
    ...
    return(
      <div>
        <div style={{height: 350, marginTop: -25, backgroundImage: 'url('+row.profile_image_url+')', backgroundSize: 'cover', position: 'relative', marginBottom: 25, backgroundPosition: 'center'}}>
          ...
          <div className='social-desc'>
            <div>
              <h1 className='fg-white' style={{textTransform: 'capitalize'}}>{row.location}</h1>
              <h5 className='fg-white' style={{opacity: 0.8}}>- {row.created_at}</h5>
          ...
          <div className='social-avatar'>
            <Img src={row.profile_image_url} height='110' width='110' style={{display: 'block', borderRadius: 100, border: '2px solid #fff', margin: 'auto', marginTop: 50}} />
            <h4 className='fg-white text-center' style={{textTransform: 'capitalize'}}>{row.first_name} {row.last_name}</h4>
            <h5 className='fg-white text-center' style={{opacity: 0.8, textTransform: 'capitalize'}}>{row.gender}</h5>
