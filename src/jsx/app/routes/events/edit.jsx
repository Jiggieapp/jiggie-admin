...
var Body = React.createClass({
  ...
  $.ajax({
    url: 'http://localhost:9000/api/events/'+ id,
    dataType: 'json',
    cache: false,
                   ...
                   <Panel>
                       <PanelHeader className='bg-darkgreen45 fg-white' style={{marginBottom: 20}}>
                         <Grid>
                           <Row>
                             <Col xs={8}>
                               <h3 style={{textTransform: 'capitalize'}}>Edit Events - {row.title}</h3>
                             </Col>
                             <Col xs={4}>
                                  ...
                                  <FormGroup>
                                    ...
                                    <FormGroup>
                                      ...
                                      <InputGroup>
                                        ...
                                        <Input autoFocus type='text' id='title' placeholder='Title Events' ref="title" name="title" value={this.state.data.title} onChange={this.handleChange}/>
                                    ...
                                    <FormGroup>
                                      ...
                                      <Textarea id='description' rows='3' placeholder='Description' ref="description" name="description" value={this.state.data.description} onChange={this.handleChange}/>
                                    </FormGroup>
                                    <FormGroup>
                                      <Label htmlFor='lastname'>Venue Name</Label>
                                      <VenueList id='venue_name' ref="venue_name" name="venue_name" data={row.venue_name} onChange={this.handleChange}/>
                                    </FormGroup>
                                    <FormGroup>
                                      ...
                                      <InputGroup>
                                        ...
                                        <Input type='text' id='start_datetime_str' placeholder='Event Start' ref="start_datetime_str" name="start_datetime_str" value={this.state.data.start_datetime_str} onChange={this.handleChange}/>
                                    ...
                                    <FormGroup>
                                      ...
                                      <InputGroup>
                                        ...
                                        <Input type='text' id='end_datetime_str' placeholder='Event Ends' ref="end_datetime_str" name="end_datetime_str" value={this.state.data.end_datetime_str} onChange={this.handleChange}/>

                                      </InputGroup>
                                    </FormGroup>
                                    <FormGroup>
                                      <Label htmlFor='description'>Location</Label>
                                      <Textarea id='lokasi' rows='3' placeholder='Event Location' ref="lokasi" name="lokasi" value={this.state.data.location} onChange={this.handleChange}/>
                                    </FormGroup>
                                ...
                                <Col xs={6}>
                                  ...
                                  <FormGroup>
                                    ...
                                    <InputGroup>
                                      ...
                                      <Input type='text' id='date_full' placeholder='date_full' ref="date_full" name="date_full" value={this.state.data.date_full} onChange={this.handleChange}/>
                                  ...
                                  <FormGroup>
                                    ...
                                    <Select id='rank' defaultValue='1' ref="rank" name="rank" onChange={this.handleChange}>
                                  ...
                                  <FormGroup>
                                    ...
                                    <InputGroup>
                                      ...
                                      <Input type='text' id='fullfillment_type' placeholder='Fullfillment Type' ref="fullfillment_type" name="fullfillment_type" value={this.state.data.fullfillment_type} onChange={this.handleChange}/>
                                  ...
                                  <FormGroup>
                                    ...
                                    <InputGroup>
                                      ...
                                      <Input type='text' id='fullfillment_value' placeholder='Fullfillment Value' ref="fullfillment_value" name="fullfillment_value" value={this.state.data.fullfillment_value} onChange={this.handleChange}/>
                                  ...
                                  <FormGroup>
                                    ...
                                    <InputGroup>
                                      ...
                                      <Input type='text' id='event_type' placeholder='Events Type' ref="event_type" name="event_type" value={this.state.data.event_type} onChange={this.handleChange}/>

                                    </InputGroup>
                                  </FormGroup>
                                  <FormGroup>
                                    <Label htmlFor='lastname'>Events status</Label>
                                      <Select id='status' ref="status" name="status" onChange={this.handleChange}>
                                  ...
                                  <FormGroup>
                                    ...
                                    <InputGroup>
                                      ...
                                      <Input type='text' id='tags' placeholder='Events Tags' ref="tags" name="tags" value={this.state.data.tags} onChange={this.handleChange}/>
                                  ...
                                  <FormGroup>
                                    ...
                                    <InputGroup>
                                      ...
                                      <Input type='text' id='source' placeholder='Events Input' ref="source" name="source" value={this.state.data.source} onChange={this.handleChange}/>
...
var VenueList = React.createClass({
  ...
  componentDidMount: function() {
    ...
    render: function() {
      ...
      //var row = this.state.datax;

      return (

        <Select id='venue_name'  ref="venue_name" name="venue_name">
          <option value="1">{this.props.data}</option>
